const Durations = ({ experience, onChange, mode, type, presentJobOption }) => {
    let to = (
        <div className="to">
...
const Month = ({ id, name, mode, label, value, onChange, disabled }) => {
...
const Year = ({ id, name, mode, label, value, onChange, disabled }) => {
...
const CurrentPositionToggle = ({ id, currentPos, onChange }) => {
    return (
